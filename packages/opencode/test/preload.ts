...
const bundledModelsPath = path.join(import.meta.dir, "../assets/models.json")
const bundledFile = Bun.file(bundledModelsPath)
if (await bundledFile.exists()) {
  await fs.writeFile(path.join(cacheDir, "models.json"), await bundledFile.text())
} else {
